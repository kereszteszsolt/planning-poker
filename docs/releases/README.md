...
| [0.2 · Experience foundation](release-0.2-experience-foundation/README.md) | Planned | Runtime hardening, Turborepo, shared contracts, Zustand, design tokens, UI polish, Penpot, screenshots, tests, and CI |
